...
public class PantallaRecibo extends javax.swing.JPanel {
    ...
    public PantallaRecibo(IModelo modelo, Controlador control) {
        ...
        menuPrincipal.add(gifCarga, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 150, 500, 500));
    ...
    public void incializarDatosTransaccion() {
        ...
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy hh:mm a", new Locale("es", "MX"));
