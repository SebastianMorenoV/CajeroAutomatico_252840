...
public class Modelo implements IModelo {
    ...
    public TransaccionDTO getTransaccion() {
        ...
        transaccionDTO.setCuenta(new CuentaDTO(cuenta.getNumeroCuenta(), cuenta.getTipoCuenta(), ocultarNumeroCuenta(cuenta.getNumeroTarjeta()), cuenta.getIdCliente(), cuenta.getSaldo()));
    ...
    public String ocultarNumeroCuenta(String numero) {
        String numeroSinEspacios = numero.replaceAll("\\s+", "");
        String ultimosCuatroDigitos = numeroSinEspacios.substring(12);
